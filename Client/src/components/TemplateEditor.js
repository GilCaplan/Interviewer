          ...
          {canViewSuggestions && fieldSuggestions.length > 0 && (
            <div className="field-suggestions">
              ...
              {fieldSuggestions.map(note => (
                <div key={note.suggestion_data.suggestion_id} className={`field-suggestion ${note.suggestion_data.author === 'AI Assistant' ? 'ai-suggestion' : 'user-suggestion'}`}>
                  <div className="suggestion-header">
                    <span className={`suggestion-author ${note.suggestion_data.author === 'AI Assistant' ? 'ai-author' : 'user-author'}`}>
                  ...
                  <div className="suggestion-content">
                    <strong>Suggested value:</strong> {note.suggestion_data.suggested_value || '[Empty suggestion]'}
                    {note.suggestion_data.author === 'AI Assistant' && (
