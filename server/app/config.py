...
class Config:
    ...
    # Rate Limiting
    LLM_REQUESTS_PER_MINUTE = int(os.environ.get('LLM_REQUESTS_PER_MINUTE') or '15')
    LLM_REQUESTS_PER_DAY = int(os.environ.get('LLM_REQUESTS_PER_DAY') or '1500')

    # High-Performance Scaling Configuration
    MAX_CONCURRENT_CONNECTIONS = int(os.environ.get('MAX_CONCURRENT_CONNECTIONS') or '2000')
    DATABASE_POOL_SIZE = int(os.environ.get('DATABASE_POOL_SIZE') or '200')  # Match ultra_scale_config
    MAX_OVERFLOW = int(os.environ.get('MAX_OVERFLOW') or '200')
    POOL_TIMEOUT = int(os.environ.get('POOL_TIMEOUT') or '30')
    POOL_RECYCLE = int(os.environ.get('POOL_RECYCLE') or '3600')
    
    # Thread Pool Configuration
    MAX_WORKERS = int(os.environ.get('MAX_WORKERS') or '500')
    THREAD_POOL_SIZE = int(os.environ.get('THREAD_POOL_SIZE') or '1000')
    
    # Request Timeout Configuration
    REQUEST_TIMEOUT = int(os.environ.get('REQUEST_TIMEOUT') or '120')
    SOCKET_TIMEOUT = int(os.environ.get('SOCKET_TIMEOUT') or '60')
